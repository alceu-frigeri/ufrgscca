...
\end{codedescribe}
\begin{tsremark}
(updated in 2024/02/15) In case some other, odd, value is assigned, this command will record as if the student is in 'exam', with the given grade \tsobj[oarg]{fate} marked in bold red.
\end{tsremark}
...
\begin{codedescribe}[code,update=2023/11/18,update=2024/02/15]{\examinergrades}
	...
	\end{codesyntax}
Quite obvious, this set the grades given by an examiner (the one defined by the 'last' \tsmacro{\examiner}{} before this.). In case \tsobj[oarg]{N4} is given it's assumed the TCC-I case, otherwise TCC-II. The 'star' at the end will mark said reviewer, in red, when generating a report.
\end{codedescribe}
