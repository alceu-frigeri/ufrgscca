...
\SetLabels{%
  ...
  advisor.email             = Email d\tccore@@ref{advisor}{article} Orientador\tccore@@ref{advisor}{narticle} ,
  ...
  student.gen               = Aluno(a) ,
  student.email             = Email d\tccore@@ref{student}{article} Alun\tccore@@ref{student}{article} ,
...
\SetForm{request-I}{body}{%
  ...
  \UseLabel{student.email} : {\bf \tc@studentAemail} %

  \UseLabel{advisor} : \tc@studentA@advisor%

  \UseLabel{advisor.email} : {\bf \tc@studentA@advisoremail}%
  \hfill \UseLabel{phone} : {\bf \tc@studentA@advisorphone}%

  {\bf Resumo}:\footnote[1]{\tcdef@forms@renewreqformnotes}%
