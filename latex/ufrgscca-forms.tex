...
\end{itemize}
    ...
    Considerações Complementares: \BlankLines{5}%\tcdef@core@formsblanklinesB
}
...
\SetForm{internshiptutorform}{body}{
    ...
    \BlankLines{5}%\tcdef@core@formsblanklinesB
...
\SetForm{advisorsapproval-I}{body}{%
  ...
  {\bf Parecer d\tccore@@ref{advisor}{article} Orientador\tccore@@ref{advisor}{narticle}}\footnote{Preenchimento Obrigatório}
...
Outras considerações, parecer (se necessário): \\
  ...
  ~\\\hline
	~\\\hline
	\end{tabular}\\[-1mm]
  \footnotetext[2]{Use uma escala de 0 à 10: \begin{enumerate*}\item[0.] Péssimo  \item[3.] Deficitário \item[6.] Bom \item[8.] Muito Bom \item[10.] Excelente \end{enumerate*}}%
