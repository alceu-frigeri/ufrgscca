...
\SetForm{cocertificate}{body}{%
  ...
  \end{center}
  \vfill
  atuou como coorientador\DataFields{student.coadvisor}{narticle} voluntári\DataFields{student.coadvisor}{article} d\DataFields{student}{article} alun\DataFields{student}{article}\ \emph{\DataFields{student}{name}}\ no Trabalho de Conclusão de Curso intitulado \emph{\DataFields{student}{worktitle}}\ no semestre \UseTerm{semester}.
}
